package ru.olegkostin.util;

/**
 * Created by OlegK on 16.11.2016.
 */
...
public class Constants {
    ...
    public static final String LEVEL_01 = "images/levels/level-01.png";
    ...
    public static final int CARROTS_SPAWN_MAX = 200;
    // Spawn radius for carrots
    public static final float CARROTS_SPAWN_RADIUS = 5.0f;
    // Delay after game finished
    public static final float TIME_DELAY_GAME_FINISHED = 8;
    // Shader
